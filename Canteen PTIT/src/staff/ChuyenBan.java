...
public class ChuyenBan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHỌN BÀN CHUYỂN ĐẾN");
    ...
    private void tblTablesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTablesMouseClicked
        ...
        if(listTables.get(id).getStatus() == 1){  // Ban nay dang duoc su dung
            JOptionPane.showMessageDialog(this, "Bàn này đang được sử dụng\nKhông thể chuyển đến !", "Thông báo lỗi", JOptionPane.WARNING_MESSAGE);
        }
        else if(listTables.get(id).getStatus() == 0){   // Ban nay dang trong
            int b = JOptionPane.showConfirmDialog(this, "Bạn có chuyển bàn này tới bàn" + listTables.get(id).getName() +" không ?", "Notice", JOptionPane.YES_NO_OPTION);
            if (b == 0) {
            int tableId_new = listTables.get(id).getId();
            
            // Chuyen ban
            orderDAO.updateTableId(order_id, tableId_new);
            //Cap nhat trang thai cua 2 ban
            tableDAO.updateStatusTable(tableId_new, 1);  // Ban moi hoat dong
            tableDAO.updateStatusTable(table_id, 0);    // Ban cu trong
            
            
            JOptionPane.showMessageDialog(this, "Chuyển bàn thành công !", "Success", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            }
        }
